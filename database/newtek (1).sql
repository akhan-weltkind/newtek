...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Фев 02 2017 г., 13:23
...
--
-- Структура таблицы `lr_categories`
--

DROP TABLE IF EXISTS `lr_categories`;
CREATE TABLE IF NOT EXISTS `lr_categories` (
  `id` int(10) unsigned NOT NULL,
...
--
-- Дамп данных таблицы `lr_categories`
--

INSERT INTO `lr_categories` (`id`, `parent_id`, `lft`, `rgt`, `depth`, `lang`, `slug`, `title`, `active`, `meta_title`, `meta_h1`, `meta_keywords`, `meta_description`, `created_at`, `updated_at`) VALUES
(1, NULL, 1, 6, 0, 'ru', '', 'Корневая категория', 1, '', '', '', '', '2017-02-02 04:00:00', '2017-02-02 04:12:09'),
(2, 1, 2, 3, 1, 'ru', '', 'Поликристалические модули', 1, '', '', '', '', '2017-02-02 04:11:47', '2017-02-02 04:14:33'),
(3, 1, 4, 5, 1, 'ru', '', 'Монокписталические модули', 1, '', '', '', '', '2017-02-02 04:12:09', '2017-02-02 04:14:33');
...
(13, '2017_02_01_104337_create_project_table', 3),
(14, '2017_02_01_105117_create_project_images_table', 4),
(15, '2017_02_02_094043_create_category_table', 5);
...
--
-- Структура таблицы `lr_projects`
--

DROP TABLE IF EXISTS `lr_projects`;
CREATE TABLE IF NOT EXISTS `lr_projects` (
  `id` int(10) unsigned NOT NULL,
...
--
-- Дамп данных таблицы `lr_projects`
--

INSERT INTO `lr_projects` (`id`, `lang`, `title`, `date`, `main_image`, `image`, `password`, `preview`, `content`, `active`, `created_at`, `updated_at`) VALUES
(1, 'ru', 'На Моспочтамте открылась «Почта Деда Мороза»', '2017-02-01 18:00:00', '1486009279_46481300.jpg', '1486009809_48025400.jpg', '', 'После того как тема сформулирована, коллективное бессознательное выбирает онтогенез речи, вызвалo и сравнительно-психологических исследований поведения. возобладает, даже эта маленькая лазейка будет закрыта. Когнитивная составляющая абсурдно отражает аутизм.', '<p>После того как тема сформулирована, коллективное бессознательное выбирает онтогенез речи, вызвалo и сравнительно-психологических исследований поведения. возобладает, даже эта маленькая лазейка будет закрыта. Когнитивная составляющая абсурдно отражает аутизм.После того как тема сформулирована, коллективное бессознательное выбирает онтогенез речи, вызвалo и сравнительно-психологических исследований поведения. возобладает, даже эта маленькая лазейка будет закрыта. Когнитивная составляющая абсурдно отражает аутизм.После того как тема сформулирована, коллективное бессознательное выбирает онтогенез речи, вызвалo и сравнительно-психологических исследований поведения. возобладает, даже эта маленькая лазейка будет закрыта. Когнитивная составляющая абсурдно отражает аутизм.После того как тема сформулирована, коллективное бессознательное выбирает онтогенез речи, вызвалo и сравнительно-психологических исследований поведения. возобладает, даже эта маленькая лазейка будет закрыта. Когнитивная составляющая абсурдно отражает аутизм.После того как тема сформулирована, коллективное бессознательное выбирает онтогенез речи, вызвалo и сравнительно-психологических исследований поведения. возобладает, даже эта маленькая лазейка будет закрыта. Когнитивная составляющая абсурдно отражает аутизм.После того как тема сформулирована, коллективное бессознательное выбирает онтогенез речи, вызвалo и сравнительно-психологических исследований поведения. возобладает, даже эта маленькая лазейка будет закрыта. Когнитивная составляющая абсурдно отражает аутизм.После того как тема сформулирована, коллективное бессознательное выбирает онтогенез речи, вызвалo и сравнительно-психологических исследований поведения. возобладает, даже эта маленькая лазейка будет закрыта. Когнитивная составляющая абсурдно отражает аутизм.</p>\r\n\r\n<p>&nbsp;</p>\r\n\r\n<p>После того как тема сформулирована, коллективное бессознательное выбирает онтогенез речи, вызвалo и сравнительно-психологических исследований поведения. возобладает, даже эта маленькая лазейка будет закрыта. Когнитивная составляющая абсурдно отражает аутизм.</p>\r\n', 1, '2017-02-01 21:20:13', '2017-02-01 22:30:09'),
(2, 'ru', 'На Моспочтамте открылась «Почта Деда Мороза»  На Моспочтамте открылась «Почта Деда Мороза»', '2017-02-01 18:00:00', '1486009913_29528100.jpg', '1486009956_10680600.jpg', '', 'После того как тема сформулирована, коллективное бессознательное выбирает онтогенез речи', '<p>После того как тема сформулирована, коллективное бессознательное выбирает онтогенез речиПосле того как тема сформулирована, коллективное бессознательное выбирает онтогенез речиПосле того как тема сформулирована, коллективное бессознательное выбирает онтогенез речиПосле того как тема сформулирована, коллективное бессознательное выбирает онтогенез речи</p>\r\n\r\n<p>После того как тема сформулирована, коллективное бессознательное выбирает онтогенез речи</p>\r\n\r\n<p>После того как тема сформулирована, коллективное бессознательное выбирает онтогенез речи</p>\r\n\r\n<p>После того как тема сформулирована, коллективное бессознательное выбирает онтогенез речи</p>\r\n\r\n<p>После того как тема сформулирована, коллективное бессознательное выбирает онтогенез речи</p>\r\n\r\n<p>После того как тема сформулирована, коллективное бессознательное выбирает онтогенез речи</p>\r\n\r\n<p>После того как тема сформулирована, коллективное бессознательное выбирает онтогенез речи</p>\r\n', 1, '2017-02-01 22:31:53', '2017-02-01 22:32:36'),
(3, 'ru', 'После того как тема сформулирована, коллективное бессознательное выбирает онтогенез речи', '2017-02-01 18:00:00', '1486011708_49538700.jpg', '1486010080_70611000.jpg', '', 'После того как тема сформулирована, коллективное бессознательное выбирает онтогенез речи', '<p>пылали точно<i>маяк</i>: всем детям в<strong>семье, кроме Фрэнка</strong>, досталось это наказанье &mdash; у всех рыжие вихры, только разных оттенков. Джек весело подтолкнул брата локтем &mdash; гляди, мол. Переглядываясь,<b>ухмыляясь</b>, они подобрались к ней с двух сторон, будто они солдаты и <u>устроили облаву на изменника маори</u>. Да Мэгги все равно бы их не услышала, она была поглощена одной только Агнес и что-то ей тихонько напевала.</p>\r\n\r\n<p>Территория Польши составляет 312 677 кв.км), территориальные воды - 8 682 кв.км (12-мильная зона). Форма Польши на карте напоминает круг, геометрическая граница которого располагается к юго-западу от Лодзи - 19о07&#39; в.д., 51о55&#39; с.ш.</p>\r\n\r\n<p>Она провела ладонью по складкам ярко-розового платья &mdash; такого великолепного платья она никогда не видала на живой женщине &mdash; и любовно взяла куклу на руки. У Агнес руки и ноги на шарнирах, их можно повернуть и согнуть как угодно; даже шея и тоненькая стройная талия сгибаются. Она провела ладонью по складкам ярко-розового платья &mdash; такого великолепного платья она никогда не видала на живой женщине &mdash; и любовно взяла куклу на руки. У Агнес руки и ноги на шарнирах, их можно повернуть и согнуть как угодно; даже шея и тоненькая стройная талия сгибаются.</p>\r\n\r\n<p>от нее немножко пахнет большим магазином в Уэхайне, и Мэгги догадывается: то, что внутри, не сами делали и никто не дал, а &mdash; вот чудеса! &mdash; купили в магазине. С одного уголка начинает просвечивать что-то тонкое, золотистое; Мэгги еще торопливей набрасывается на обертку, отдирает от нее длинные неровные полосы. от нее немножко пахнет большим магазином в Уэхайне, и Мэгги догадывается: то, что внутри, не сами делали и никто не дал, а &mdash; вот чудеса! &mdash; купили в магазине. С одного уголка начинает просвечивать что-то тонкое, золотистое; Мэгги еще торопливей набрасывается на обертку, отдирает от нее длинные неровные полосы.от нее немножко пахнет большим магазином в Уэхайне, и Мэгги догадывается: то, что внутри, не сами делали и никто не дал, а &mdash; вот чудеса! &mdash; купили в магазине. С одного уголка начинает просвечивать что-то тонкое, золотистое; Мэгги еще торопливей набрасывается на обертку, отдирает от нее длинные неровные полосы.</p>\r\n\r\n<p>от нее немножко пахнет большим магазином в Уэхайне, и Мэгги догадывается: то, что внутри, не сами делали и никто не дал, а &mdash; вот чудеса! &mdash; купили в магазине. С одного уголка начинает просвечивать что-то тонкое, золотистое; Мэгги еще торопливей набрасывается на обертку, отдирает от нее длинные неровные полосы.</p>\r\n\r\n<table class="table">\r\n	<thead>\r\n		<tr>\r\n			<th>Заголовок первого столбца</th>\r\n			<th>Очень, очень, очень, приочень длинный заголовок второго столбца таблицы</th>\r\n		</tr>\r\n	</thead>\r\n	<tbody>\r\n		<tr>\r\n			<td>Мэгги уютно скрестила ноги, осторожно усадила куклу</td>\r\n			<td>на колени к себе &mdash; сидела и не сводила с нее глаз.</td>\r\n		</tr>\r\n		<tr>\r\n			<td>Она все еще сидела там, под кустом, когда из зарослей высокой травы</td>\r\n			<td>так близко к забору ее неудобно косить</td>\r\n		</tr>\r\n		<tr>\r\n			<td>вынырнули Джек и Хьюги. Волосы Мэгги, как у истинной Клири</td>\r\n			<td>пылали точно маяк: всем детям в семье, кроме Фрэнка, досталось это наказанье</td>\r\n		</tr>\r\n	</tbody>\r\n</table>\r\n', 1, '2017-02-01 22:33:58', '2017-02-01 23:01:48'),
(4, 'ru', 'Проект примерный', '2017-02-01 18:00:00', '1486011690_66626100.jpg', '1486010147_35402300.jpg', '', 'Проект примерныйПроект примерный\r\nПроект примерныйПроект примерный\r\nПроект примерный Проект примерный\r\nПроект примерный Проект примерный', '<p>пылали точно<i>маяк</i>: всем детям в<strong>семье, кроме Фрэнка</strong>, досталось это наказанье &mdash; у всех рыжие вихры, только разных оттенков. Джек весело подтолкнул брата локтем &mdash; гляди, мол. Переглядываясь,<b>ухмыляясь</b>, они подобрались к ней с двух сторон, будто они солдаты и <u>устроили облаву на изменника маори</u>. Да Мэгги все равно бы их не услышала, она была поглощена одной только Агнес и что-то ей тихонько напевала.</p>\r\n\r\n<p>Территория Польши составляет 312 677 кв.км), территориальные воды - 8 682 кв.км (12-мильная зона). Форма Польши на карте напоминает круг, геометрическая граница которого располагается к юго-западу от Лодзи - 19о07&#39; в.д., 51о55&#39; с.ш.</p>\r\n\r\n<p>Она провела ладонью по складкам ярко-розового платья &mdash; такого великолепного платья она никогда не видала на живой женщине &mdash; и любовно взяла куклу на руки. У Агнес руки и ноги на шарнирах, их можно повернуть и согнуть как угодно; даже шея и тоненькая стройная талия сгибаются. Она провела ладонью по складкам ярко-розового платья &mdash; такого великолепного платья она никогда не видала на живой женщине &mdash; и любовно взяла куклу на руки. У Агнес руки и ноги на шарнирах, их можно повернуть и согнуть как угодно; даже шея и тоненькая стройная талия сгибаются.</p>\r\n\r\n<p>от нее немножко пахнет большим магазином в Уэхайне, и Мэгги догадывается: то, что внутри, не сами делали и никто не дал, а &mdash; вот чудеса! &mdash; купили в магазине. С одного уголка начинает просвечивать что-то тонкое, золотистое; Мэгги еще торопливей набрасывается на обертку, отдирает от нее длинные неровные полосы. от нее немножко пахнет большим магазином в Уэхайне, и Мэгги догадывается: то, что внутри, не сами делали и никто не дал, а &mdash; вот чудеса! &mdash; купили в магазине. С одного уголка начинает просвечивать что-то тонкое, золотистое; Мэгги еще торопливей набрасывается на обертку, отдирает от нее длинные неровные полосы.от нее немножко пахнет большим магазином в Уэхайне, и Мэгги догадывается: то, что внутри, не сами делали и никто не дал, а &mdash; вот чудеса! &mdash; купили в магазине. С одного уголка начинает просвечивать что-то тонкое, золотистое; Мэгги еще торопливей набрасывается на обертку, отдирает от нее длинные неровные полосы.</p>\r\n\r\n<p>от нее немножко пахнет большим магазином в Уэхайне, и Мэгги догадывается: то, что внутри, не сами делали и никто не дал, а &mdash; вот чудеса! &mdash; купили в магазине. С одного уголка начинает просвечивать что-то тонкое, золотистое; Мэгги еще торопливей набрасывается на обертку, отдирает от нее длинные неровные полосы.</p>\r\n\r\n<table class="table">\r\n	<thead>\r\n		<tr>\r\n			<th>Заголовок первого столбца</th>\r\n			<th>Очень, очень, очень, приочень длинный заголовок второго столбца таблицы</th>\r\n		</tr>\r\n	</thead>\r\n	<tbody>\r\n		<tr>\r\n			<td>Мэгги уютно скрестила ноги, осторожно усадила куклу</td>\r\n			<td>на колени к себе &mdash; сидела и не сводила с нее глаз.</td>\r\n		</tr>\r\n		<tr>\r\n			<td>Она все еще сидела там, под кустом, когда из зарослей высокой травы</td>\r\n			<td>так близко к забору ее неудобно косить</td>\r\n		</tr>\r\n		<tr>\r\n			<td>вынырнули Джек и Хьюги. Волосы Мэгги, как у истинной Клири</td>\r\n			<td>пылали точно маяк: всем детям в семье, кроме Фрэнка, досталось это наказань</td>\r\n		</tr>\r\n	</tbody>\r\n</table>\r\n', 1, '2017-02-01 22:35:28', '2017-02-02 00:09:40'),
(5, 'ru', 'Проект примерный2', '2017-02-01 18:00:00', '1486011667_23181800.jpg', '1486010211_81082800.jpg', '', 'Проект примерный\r\nПроект примерный\r\nПроект примерный2', '<p>пылали точно<i>маяк</i>: всем детям в<strong>семье, кроме Фрэнка</strong>, досталось это наказанье &mdash; у всех рыжие вихры, только разных оттенков. Джек весело подтолкнул брата локтем &mdash; гляди, мол. Переглядываясь,<b>ухмыляясь</b>, они подобрались к ней с двух сторон, будто они солдаты и <u>устроили облаву на изменника маори</u>. Да Мэгги все равно бы их не услышала, она была поглощена одной только Агнес и что-то ей тихонько напевала.</p>\r\n\r\n<p>Территория Польши составляет 312 677 кв.км), территориальные воды - 8 682 кв.км (12-мильная зона). Форма Польши на карте напоминает круг, геометрическая граница которого располагается к юго-западу от Лодзи - 19о07&#39; в.д., 51о55&#39; с.ш.</p>\r\n\r\n<p>Она провела ладонью по складкам ярко-розового платья &mdash; такого великолепного платья она никогда не видала на живой женщине &mdash; и любовно взяла куклу на руки. У Агнес руки и ноги на шарнирах, их можно повернуть и согнуть как угодно; даже шея и тоненькая стройная талия сгибаются. Она провела ладонью по складкам ярко-розового платья &mdash; такого великолепного платья она никогда не видала на живой женщине &mdash; и любовно взяла куклу на руки. У Агнес руки и ноги на шарнирах, их можно повернуть и согнуть как угодно; даже шея и тоненькая стройная талия сгибаются.</p>\r\n\r\n<p>от нее немножко пахнет большим магазином в Уэхайне, и Мэгги догадывается: то, что внутри, не сами делали и никто не дал, а &mdash; вот чудеса! &mdash; купили в магазине. С одного уголка начинает просвечивать что-то тонкое, золотистое; Мэгги еще торопливей набрасывается на обертку, отдирает от нее длинные неровные полосы. от нее немножко пахнет большим магазином в Уэхайне, и Мэгги догадывается: то, что внутри, не сами делали и никто не дал, а &mdash; вот чудеса! &mdash; купили в магазине. С одного уголка начинает просвечивать что-то тонкое, золотистое; Мэгги еще торопливей набрасывается на обертку, отдирает от нее длинные неровные полосы.от нее немножко пахнет большим магазином в Уэхайне, и Мэгги догадывается: то, что внутри, не сами делали и никто не дал, а &mdash; вот чудеса! &mdash; купили в магазине. С одного уголка начинает просвечивать что-то тонкое, золотистое; Мэгги еще торопливей набрасывается на обертку, отдирает от нее длинные неровные полосы.</p>\r\n\r\n<p>от нее немножко пахнет большим магазином в Уэхайне, и Мэгги догадывается: то, что внутри, не сами делали и никто не дал, а &mdash; вот чудеса! &mdash; купили в магазине. С одного уголка начинает просвечивать что-то тонкое, золотистое; Мэгги еще торопливей набрасывается на обертку, отдирает от нее длинные неровные полосы.</p>\r\n\r\n<table class="table">\r\n	<thead>\r\n		<tr>\r\n			<th>Заголовок первого столбца</th>\r\n			<th>Очень, очень, очень, приочень длинный заголовок второго столбца таблицы</th>\r\n		</tr>\r\n	</thead>\r\n	<tbody>\r\n		<tr>\r\n			<td>Мэгги уютно скрестила ноги, осторожно усадила куклу</td>\r\n			<td>на колени к себе &mdash; сидела и не сводила с нее глаз.</td>\r\n		</tr>\r\n		<tr>\r\n			<td>Она все еще сидела там, под кустом, когда из зарослей высокой травы</td>\r\n			<td>так близко к забору ее неудобно косить</td>\r\n		</tr>\r\n		<tr>\r\n			<td>вынырнули Джек и Хьюги. Волосы Мэгги, как у истинной Клири</td>\r\n			<td>пылали точно маяк: всем детям в семье, кроме Фрэнка, досталось это наказанье</td>\r\n		</tr>\r\n	</tbody>\r\n</table>\r\n', 1, '2017-02-01 22:36:31', '2017-02-01 23:01:07'),
(6, 'ru', 'На Моспочтамте открылась «Почта Деда Мороза» ', '2017-01-31 18:00:00', '1486011648_64965500.jpg', '', '', 'После того как тема сформулирована, коллективное бессознательное выбирает онтогенез речи, вызвалo и сравнительно-психологических исследований поведения. Как было показано выше, анима последовательно Когнитивная составляющая абсурдно отражает аутизм.', '<p>пылали точно<i>маяк</i>: всем детям в<strong>семье, кроме Фрэнка</strong>, досталось это наказанье &mdash; у всех рыжие вихры, только разных оттенков. Джек весело подтолкнул брата локтем &mdash; гляди, мол. Переглядываясь,<b>ухмыляясь</b>, они подобрались к ней с двух сторон, будто они солдаты и <u>устроили облаву на изменника маори</u>. Да Мэгги все равно бы их не услышала, она была поглощена одной только Агнес и что-то ей тихонько напевала.</p>\r\n\r\n<p>Территория Польши составляет 312 677 кв.км), территориальные воды - 8 682 кв.км (12-мильная зона). Форма Польши на карте напоминает круг, геометрическая граница которого располагается к юго-западу от Лодзи - 19о07&#39; в.д., 51о55&#39; с.ш.</p>\r\n\r\n<p>Она провела ладонью по складкам ярко-розового платья &mdash; такого великолепного платья она никогда не видала на живой женщине &mdash; и любовно взяла куклу на руки. У Агнес руки и ноги на шарнирах, их можно повернуть и согнуть как угодно; даже шея и тоненькая стройная талия сгибаются. Она провела ладонью по складкам ярко-розового платья &mdash; такого великолепного платья она никогда не видала на живой женщине &mdash; и любовно взяла куклу на руки. У Агнес руки и ноги на шарнирах, их можно повернуть и согнуть как угодно; даже шея и тоненькая стройная талия сгибаются.</p>\r\n\r\n<p>от нее немножко пахнет большим магазином в Уэхайне, и Мэгги догадывается: то, что внутри, не сами делали и никто не дал, а &mdash; вот чудеса! &mdash; купили в магазине. С одного уголка начинает просвечивать что-то тонкое, золотистое; Мэгги еще торопливей набрасывается на обертку, отдирает от нее длинные неровные полосы. от нее немножко пахнет большим магазином в Уэхайне, и Мэгги догадывается: то, что внутри, не сами делали и никто не дал, а &mdash; вот чудеса! &mdash; купили в магазине. С одного уголка начинает просвечивать что-то тонкое, золотистое; Мэгги еще торопливей набрасывается на обертку, отдирает от нее длинные неровные полосы.от нее немножко пахнет большим магазином в Уэхайне, и Мэгги догадывается: то, что внутри, не сами делали и никто не дал, а &mdash; вот чудеса! &mdash; купили в магазине. С одного уголка начинает просвечивать что-то тонкое, золотистое; Мэгги еще торопливей набрасывается на обертку, отдирает от нее длинные неровные полосы.</p>\r\n\r\n<p>от нее немножко пахнет большим магазином в Уэхайне, и Мэгги догадывается: то, что внутри, не сами делали и никто не дал, а &mdash; вот чудеса! &mdash; купили в магазине. С одного уголка начинает просвечивать что-то тонкое, золотистое; Мэгги еще торопливей набрасывается на обертку, отдирает от нее длинные неровные полосы.</p>\r\n\r\n<table class="table">\r\n	<thead>\r\n		<tr>\r\n			<th>Заголовок первого столбца</th>\r\n			<th>Очень, очень, очень, приочень длинный заголовок второго столбца таблицы</th>\r\n		</tr>\r\n	</thead>\r\n	<tbody>\r\n		<tr>\r\n			<td>Мэгги уютно скрестила ноги, осторожно усадила куклу</td>\r\n			<td>на колени к себе &mdash; сидела и не сводила с нее глаз.</td>\r\n		</tr>\r\n		<tr>\r\n			<td>Она все еще сидела там, под кустом, когда из зарослей высокой травы</td>\r\n			<td>так близко к забору ее неудобно косить</td>\r\n		</tr>\r\n		<tr>\r\n			<td>вынырнули Джек и Хьюги. Волосы Мэгги, как у истинной Клири</td>\r\n			<td>пылали точно маяк: всем детям в семье, кроме Фрэнка, досталось это наказанье</td>\r\n		</tr>\r\n	</tbody>\r\n</table>\r\n', 1, '2017-02-01 22:37:51', '2017-02-02 02:08:55'),
(7, 'ru', 'На Моспочтамте открылась «Почта Деда Мороза»', '2017-02-01 18:00:00', '1486011621_11888700.jpg', '1486010330_02076400.jpg', '', 'После того как тема сформулирована, коллективное бессознательное выбирает онтогенез речи, вызвалo и сравнительно-психологических исследований поведения. Как было показано выше, анима последовательно Когнитивная составляющая абсурдно отражает аутизм.', '<p>пылали точно<i>маяк</i>: всем детям в<strong>семье, кроме Фрэнка</strong>, досталось это наказанье &mdash; у всех рыжие вихры, только разных оттенков. Джек весело подтолкнул брата локтем &mdash; гляди, мол. Переглядываясь,<b>ухмыляясь</b>, они подобрались к ней с двух сторон, будто они солдаты и <u>устроили облаву на изменника маори</u>. Да Мэгги все равно бы их не услышала, она была поглощена одной только Агнес и что-то ей тихонько напевала.<br />\r\nТерритория Польши составляет 312 677 кв.км), территориальные воды - 8 682 кв.км (12-мильная зона). Форма Польши на карте напоминает круг, геометрическая граница которого располагается к юго-западу от Лодзи - 19о07&#39; в.д., 51о55&#39; с.ш.<br />\r\nОна провела ладонью по складкам ярко-розового платья &mdash; такого великолепного платья она никогда не видала на живой женщине &mdash; и любовно взяла куклу на руки. У Агнес руки и ноги на шарнирах, их можно повернуть и согнуть как угодно; даже шея и тоненькая стройная талия сгибаются. &nbsp;Она провела ладонью по складкам ярко-розового платья &mdash; такого великолепного платья она никогда не видала на живой женщине &mdash; и любовно взяла куклу на руки. У Агнес руки и ноги на шарнирах, их можно повернуть и согнуть как угодно; даже шея и тоненькая стройная талия сгибаются.<br />\r\nот нее немножко пахнет большим магазином в Уэхайне, и Мэгги догадывается: то, что внутри, не сами делали и никто не дал, а &mdash; вот чудеса! &mdash; купили в магазине. С одного уголка начинает просвечивать что-то тонкое, золотистое; Мэгги еще торопливей набрасывается на обертку, отдирает от нее длинные неровные полосы. от нее немножко пахнет большим магазином в Уэхайне, и Мэгги догадывается: то, что внутри, не сами делали и никто не дал, а &mdash; вот чудеса! &mdash; купили в магазине. С одного уголка начинает просвечивать что-то тонкое, золотистое; Мэгги еще торопливей набрасывается на обертку, отдирает от нее длинные неровные полосы.от нее немножко пахнет большим магазином в Уэхайне, и Мэгги догадывается: то, что внутри, не сами делали и никто не дал, а &mdash; вот чудеса! &mdash; купили в магазине. С одного уголка начинает просвечивать что-то тонкое, золотистое; Мэгги еще торопливей набрасывается на обертку, отдирает от нее длинные неровные полосы.<br />\r\n&nbsp;от нее немножко пахнет большим магазином в Уэхайне, и Мэгги догадывается: то, что внутри, не сами делали и никто не дал, а &mdash; вот чудеса! &mdash; купили в магазине. С одного уголка начинает просвечивать что-то тонкое, золотистое; Мэгги еще торопливей набрасывается на обертку, отдирает от нее длинные неровные полосы.&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;</p>\r\n\r\n<table class="table">\r\n	<thead>\r\n		<tr>\r\n			<th><br />\r\n			&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;Заголовок первого столбца<br />\r\n			&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</th>\r\n			<th><br />\r\n			&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;Очень, очень, очень, приочень длинный заголовок второго столбца таблицы<br />\r\n			&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</th>\r\n		</tr>\r\n	</thead>\r\n	<tbody>\r\n		<tr>\r\n			<td>Мэгги уютно скрестила ноги, осторожно усадила куклу<br />\r\n			&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</td>\r\n			<td><br />\r\n			на колени к себе &mdash; сидела и не сводила с нее глаз.<br />\r\n			&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</td>\r\n		</tr>\r\n		<tr>\r\n			<td><br />\r\n			&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;Она все еще сидела там, под кустом, когда из зарослей высокой травы<br />\r\n			&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</td>\r\n			<td><br />\r\n			&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;так близко к забору ее неудобно косить<br />\r\n			&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</td>\r\n		</tr>\r\n		<tr>\r\n			<td><br />\r\n			&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;вынырнули Джек и Хьюги. Волосы Мэгги, как у истинной Клири<br />\r\n			&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</td>\r\n			<td><br />\r\n			&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;пылали точно маяк: всем детям в семье, кроме Фрэнка, досталось это наказанье<br />\r\n			&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</td>\r\n		</tr>\r\n	</tbody>\r\n</table>\r\n\r\n<p>&nbsp;</p>\r\n', 1, '2017-02-01 22:38:37', '2017-02-02 00:05:24'),
(8, 'ru', 'Проект без картинки и слайдера', '2017-02-09 18:00:00', '', '', '', 'На Моспочтамте открылась «Почта Деда Мороза» \r\nНа Моспочтамте открылась «Почта Деда Мороза» \r\nНа Моспочтамте открылась «Почта Деда Мороза» ', '<p>На Моспочтамте открылась &laquo;Почта Деда Мороза&raquo;&nbsp;На Моспочтамте открылась &laquo;Почта Деда Мороза&raquo;&nbsp;На Моспочтамте открылась &laquo;Почта Деда Мороза&raquo;&nbsp;На Моспочтамте открылась &laquo;Почта Деда Мороза&raquo;&nbsp;На Моспочтамте открылась &laquo;Почта Деда Мороза&raquo;&nbsp;На Моспочтамте открылась &laquo;Почта Деда Мороза&raquo;&nbsp;На Моспочтамте открылась &laquo;Почта Деда Мороза&raquo;&nbsp;На Моспочтамте открылась &laquo;Почта Деда Мороза&raquo;&nbsp;На Моспочтамте открылась &laquo;Почта Деда Мороза&raquo;&nbsp;На Моспочтамте открылась &laquo;Почта Деда Мороза&raquo;&nbsp;На Моспочтамте открылась &laquo;Почта Деда Мороза&raquo;&nbsp;На Моспочтамте открылась &laquo;Почта Деда Мороза&raquo;&nbsp;На Моспочтамте открылась &laquo;Почта Деда Мороза&raquo;&nbsp;На Моспочтамте открылась &laquo;Почта Деда Мороза&raquo;&nbsp;На Моспочтамте открылась &laquo;Почта Деда Мороза&raquo;&nbsp;На Моспочтамте открылась &laquo;Почта Деда Мороза&raquo;&nbsp;</p>\r\n\r\n<p>На Моспочтамте открылась &laquo;Почта Деда Мороза&raquo;&nbsp;На Моспочтамте открылась &laquo;Почта Деда Мороза&raquo;&nbsp;На Моспочтамте открылась &laquo;Почта Деда Мороза&raquo;&nbsp;На Моспочтамте открылась &laquo;Почта Деда Мороза&raquo;&nbsp;На Моспочтамте открылась &laquo;Почта Деда Мороза&raquo;&nbsp;</p>\r\n', 1, '2017-02-01 23:14:10', '2017-02-02 02:12:02');

-- --------------------------------------------------------

--
-- Структура таблицы `lr_projects_images`
--

DROP TABLE IF EXISTS `lr_projects_images`;
CREATE TABLE IF NOT EXISTS `lr_projects_images` (
  `id` int(10) unsigned NOT NULL,
...
--
-- Дамп данных таблицы `lr_projects_images`
--

INSERT INTO `lr_projects_images` (`id`, `project_id`, `position`, `image`) VALUES
(7, 1, 0, '1486009347_19490600.jpg'),
(8, 1, 0, '1486009354_75734500.jpg'),
(13, 1, 0, '1486009807_64714900.jpg'),
(14, 2, 0, '1486009922_11882700.jpg'),
(15, 2, 0, '1486009926_87210300.jpg'),
(16, 2, 0, '1486009942_07297600.jpg'),
(17, 2, 0, '1486009951_05249200.jpg'),
(18, 3, 0, '1486010058_00778700.jpg'),
(20, 3, 0, '1486010066_52128500.jpg'),
(21, 3, 0, '1486010076_45686600.jpg'),
(22, 4, 0, '1486010134_88930000.jpg'),
(23, 4, 0, '1486010140_08760100.jpg'),
(24, 4, 0, '1486010145_11489000.jpg'),
(25, 5, 0, '1486010201_53523000.jpg'),
(26, 5, 0, '1486010205_50146200.jpg'),
(27, 5, 0, '1486010209_94972000.jpg'),
(28, 7, 0, '1486010324_36243300.jpg'),
(29, 7, 0, '1486010328_58768200.jpg');
...
(7, 1, 14, 19, 1, 'ru', 'catalog', 'Каталог продукции', '', '', 'inner', 1, 1, 1, 3, '', '', '', '', '2017-01-27 04:50:18', '2017-02-02 03:28:32'),
(8, 7, 15, 16, 2, 'ru', 'polycrystalline-modules', 'Поликристалические модули', '', '', 'inner', 1, 1, 1, 0, '', '', '', '', '2017-01-27 04:50:18', '2017-02-02 03:28:32'),
(9, 7, 17, 18, 2, 'ru', 'monokristalicheskie-modules', 'Монокристалические модули', '', '', 'inner', 1, 1, 1, 0, '', '', '', '', '2017-01-27 04:50:18', '2017-02-02 03:28:32'),
(10, 1, 20, 21, 1, 'ru', 'about-solar-modules', 'О солнечных модулях', '', 'news', 'list', 1, 1, 1, 2, '', '', '', '', '2017-01-27 04:50:18', '2017-02-02 03:28:32'),
(11, 1, 22, 23, 1, 'ru', 'technologies', 'Технологии', '', '', 'inner', 1, 1, 1, 2, '', '', '', '', '2017-01-27 04:50:18', '2017-02-02 03:28:32'),
(12, 1, 24, 25, 1, 'ru', 'projects', 'Проекты', '', 'project', 'inner', 1, 1, 1, 2, '', '', '', '', '2017-01-27 04:50:18', '2017-02-02 03:28:32'),
(13, 1, 26, 27, 1, 'ru', 'contacts', 'Контакты', '<h6>Контактные данные:</h6>\r\n<ul>\r\n	<li class="contacts__item"><b>Почта:</b> <a href="mailto:info@gmail.com">info@gmail.com</a></li>\r\n	<li class="contacts__item"><b>Телефон:</b> +996 551 756 436 (есть WhatsApp)</li>\r\n	<li class="contacts__item"><b>Скайп:</b> <a href="skype:weltkind_">skypename</a></li>\r\n	<li class="contacts__item"><b>Адрес:</b> 720000, Кыргызстан, г.Бишкек, пр.Чуй 130, 456</li>\r\n</ul>\r\n', 'feedback', 'inner', 1, 1, 1, 2, '', '', '', '', '2017-01-27 04:50:18', '2017-02-02 03:28:32'),
(14, 2, 11, 12, 2, 'ru', 'vacancy', 'Вакансии', '<p>сущ.</p>\r\n\r\n<p>vacancy</p>\r\n\r\n<p>сущ.</p>\r\n\r\n<p>vacancy</p>\r\n\r\n<p>сущ.</p>\r\n\r\n<p>vacancy</p>\r\n\r\n<p>сущ.</p>\r\n\r\n<p>vacancy</p>\r\n', '', 'inner', 1, 1, 1, 0, '', '', '', '', '2017-01-31 03:35:30', '2017-02-02 03:28:32');
...
--
-- Индексы таблицы `lr_categories`
--
ALTER TABLE `lr_categories`
  ADD PRIMARY KEY (`id`),
...
--
-- Индексы таблицы `lr_projects`
--
ALTER TABLE `lr_projects`
  ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `lr_projects_images`
--
ALTER TABLE `lr_projects_images`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT для таблицы `lr_categories`
--
ALTER TABLE `lr_categories`
...
--
-- AUTO_INCREMENT для таблицы `lr_projects`
--
ALTER TABLE `lr_projects`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=9;
--
-- AUTO_INCREMENT для таблицы `lr_projects_images`
--
ALTER TABLE `lr_projects_images`
